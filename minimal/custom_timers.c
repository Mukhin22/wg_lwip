...
#ifndef WIREGUARDIF_TIMER_MSECS
#define WIREGUARDIF_TIMER_MSECS 400
#endif /* WIREGUARDIF_TIMER_MSECS */

#ifndef MEMP_SYS_TIMEOUT
#define MEMP_SYS_TIMEOUT 6
#endif /* MEMP_SYS_TIMEOUT */
...
#endif /* LWIP_ARP */
#endif /* LWIP_IPV4 */
  {WIREGUARDIF_TIMER_MSECS , HANDLER(wireguardif_tmr)},
};
